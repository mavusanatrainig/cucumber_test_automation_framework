  ...
  Feature: Pay Bill
    Background: User logged in with valid user credentials
    Scenario Outline: Paying the bill to user account
      ...
      Examples:
        ...
        | Taylor    | 143 Kent Avenue | Johannesburg | Johannesburg | 4000    | 0612345678  | 1122334455    |                     | 500    | Account number is required  |
        | Taylor    | 143 Kent Avenue | Johannesburg | Johannesburg | 4000    | 0612345678  |               | 1122334455          | 500    | Account number is required  |
